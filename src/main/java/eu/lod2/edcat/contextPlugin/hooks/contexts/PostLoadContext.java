...
public class PostLoadContext implements PostContextBase {
  ...
  /**
   * Constructs a new PostLoadContext with all variables set.
   */
  public PostLoadContext(HttpServletRequest request, ResponseEntity<Object> response, Model statements){
    setRequest( request );
