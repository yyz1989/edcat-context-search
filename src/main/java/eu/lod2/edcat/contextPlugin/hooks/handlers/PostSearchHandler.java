 ...
 */
public interface PostSearchHandler extends HookHandler {
   ...
   * @see eu.lod2.edcat.contextPlugin.hooks.contexts.PostSearchContext
   */
  public void handlePostSearch(PostSearchContext context);
